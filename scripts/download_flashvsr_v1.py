...
MODEL_ID = "AI-ModelScope/FlashVSR"
MODEL_FILES = {
    "diffusion_pytorch_model_streaming_dmd.safetensors": (
        5_676_070_392,
        "b05be65078a22000d8efdb6ce212133fd043255371c015329e9f3d31645c62c5",
    ),
    "LQ_proj_in.ckpt": (
        575_695_268,
        "7ad76b2cc682d72e9521c5fa6bf15850c974c8aff9a04c92882b49c0517ffb94",
    ),
    "TCDecoder.ckpt": (
        189_018_333,
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Download and verify FlashVSR v1 Tiny from ModelScope."
    )
    parser.add_argument(
        "--local-dir",
        type=Path,
        default=repo_root / "examples" / "WanVSR" / "FlashVSR",
    )
    parser.add_argument(
        "--cache-dir", type=Path, default=repo_root / ".modelscope-cache"
    )
